...
h = tkinter.Label(top,bg="gray18")
h.pack()
msg_list = tkinter.Listbox(messages_frame, height=25,width=140,bd=6,relief="groove",highlightthickness=3,highlightcolor="whitesmoke",selectbackground="black",font="Arial 16",fg="white",bg="gray18", yscrollcommand=scrollbar.set)
...
h = tkinter.Label(top,bg="gray18")
h.pack()
entry_field = tkinter.Entry(top, width=50,font="Helvetica 23",bg="gray15",fg="white",textvariable=my_msg)
h = tkinter.Label(top,bg="gray18")
h.pack()
...
init()
HOST = "localhost" #"3.21.60.148"-Ngrok (default)
init()
print(w+"\n\n"+r+"CHAT_"+g+"Client")
print(w+"--> Version 1.0 \n--> Autor: Pulsar\n\n")
PORT = 1337
